...
def tree_generation_simphy(num_taxa: int, height: float, sub_rate: float, output_path: str):
    ...
    # os.system(command)
    # print(command)
    # os.system('./SimPhy_1.0.2/bin/simphy_lnx64 -sb f:0.1 -lt f:0.2 -rs 10 -rl f:2 -rg 1 -sp f:10 -su f:0.1 -sg f:1 -sl f:5 -st f:1.5 -v 2 '+' -o ' + output_path)
    os.system(
        './SimPhy_1.0.2/bin/simphy_lnx64 -sb f:0.1 -rs 10 -rl f:2 -rg 1 -sp f:2 -su f:0.1 -sg f:1 -sl f:4 -st f:1.5 -v 2 ' + ' -o ' + output_path)
