...
if __name__ == '__main__':
    ...
    s_tree = load_tree(SIMPHY_PATH + '1/s_tree.trees', 'newick')
    g_tree = load_tree(SIMPHY_PATH + '1/g_trees09.trees', 'newick')
    seqs = load_aln(SIMPHY_PATH + '1/data_09_TRUE.phy', 'phylip')
    ...
    # Phylo.draw(g_tree)
    # plot_histogram_2d_compare(model_distance, tree_distance, names, 'data_09')
    plot_sliding_window(model_distance_list,(len(seqs[0])-WINDOW_SIZE),SLIDING_STEP,names)
